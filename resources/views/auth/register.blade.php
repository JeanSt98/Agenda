          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="{{route('register')}}" method="post">
                  ...
                  <input type="password" name="password_confirmation" id="form2Example22" class="form-control" placeholder="Ingrese nuevamente su contraseña" />
                  </div>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                ...
                <p class="small mb-0">Por favor ingrese los datos correspondientes:<br>
