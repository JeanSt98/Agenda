            ...
            <div
              ...
              @role('admin')
                <div class="float-right">
                  <a href="{{ route('escaner_distrito.create') }}"
                ...
                <tbody>
                  @foreach ($escanerDistritos as $escanerDistrito)
                    <tr>
                      ...
                      <td>
                        <form
                          action="{{ route('escaner_distrito.destroy', $escanerDistrito->id) }}"
                          method="POST" class="d-inline eliminar">
                          <a class="btn btn-sm btn-primary "
                            href="{{ route('escaner_distrito.show', $escanerDistrito->id) }}"><i
                              class="fa fa-fw fa-eye"></i></a>
                          @role('admin')
                            <a class="btn btn-sm btn-success"
                              href="{{ route('escaner_distrito.edit', $escanerDistrito->id) }}"><i
                                class="fa fa-fw fa-edit"></i></a>
                          @endrole
                          @csrf
                          @method('DELETE')
                          @role('admin')
                            <button onclick="miFunc()"
